...
export class BarComponent extends PieDisplayComponent implements OnInit, AfterViewInit {

  constructor() {
    super();
  }
  @ViewChild('option') option!: MatListOption;
  ...
  ngAfterViewInit(): void {
    ...
    this.option.focus();
    console.log('focus option', this.option);
  }
